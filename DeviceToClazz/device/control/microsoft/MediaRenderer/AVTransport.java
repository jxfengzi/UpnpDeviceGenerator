...
public class AVTransport extends AbstractService {
    ...
    public int Next(Long InstanceID, final Next_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_Next);;
            if (action == null) {
    ...
    public int Seek(Long InstanceID, A_ARG_TYPE_SeekMode Unit, String Target, final Seek_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_Seek);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetTransportInfo(Long InstanceID, final GetTransportInfo_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetTransportInfo);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int Previous(Long InstanceID, final Previous_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_Previous);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetMediaInfo(Long InstanceID, final GetMediaInfo_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetMediaInfo);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetDeviceCapabilities(Long InstanceID, final GetDeviceCapabilities_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetDeviceCapabilities);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetCurrentTransportActions(Long InstanceID, final GetCurrentTransportActions_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetCurrentTransportActions);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int SetAVTransportURI(Long InstanceID, String CurrentURI, String CurrentURIMetaData, final SetAVTransportURI_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_SetAVTransportURI);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetPositionInfo(Long InstanceID, final GetPositionInfo_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetPositionInfo);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
    ...
    public int GetTransportSettings(Long InstanceID, final GetTransportSettings_CompletedHandler handler) {
        ...
        do {
            ActionInvocation action = ActionInvocationFactory.create(service, ACTION_GetTransportSettings);;
            if (action == null) {
                ret = ReturnCode.E_ACTION_NOT_SUPPORT;
                break;
            }
