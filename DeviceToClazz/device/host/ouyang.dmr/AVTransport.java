...
public class AVTransport implements ServiceActionHandler {
    ...
    public interface Handler {
        boolean onNext(Long theInstanceID);
        boolean onSeek(Long theInstanceID, A_ARG_TYPE_SeekMode theUnit, String theTarget);
        boolean onPlay(Long theInstanceID, TransportPlaySpeed theSpeed);
        boolean onGetTransportInfo(Long theInstanceID, GetTransportInfo_Result result);
        boolean onPrevious(Long theInstanceID);
        boolean onGetMediaInfo(Long theInstanceID, GetMediaInfo_Result result);
        boolean onGetDeviceCapabilities(Long theInstanceID, GetDeviceCapabilities_Result result);
        boolean onPause(Long theInstanceID);
        boolean onGetCurrentTransportActions(Long theInstanceID, GetCurrentTransportActions_Result result);
        boolean onSetAVTransportURI(Long theInstanceID, String theCurrentURI, String theCurrentURIMetaData);
        boolean onGetPositionInfo(Long theInstanceID, GetPositionInfo_Result result);
        boolean onStop(Long theInstanceID);
        boolean onGetTransportSettings(Long theInstanceID, GetTransportSettings_Result result);
    }

    private boolean handle_Next(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Next_ARG_InstanceID);

        if (_handler.onNext(theInstanceID)) {
            return true;
        }
    ...
    private boolean handle_Seek(ActionInfo info) {
        ...
        if (_handler.onSeek(theInstanceID, theUnit, theTarget)) {
            return true;
        }
    ...
    private boolean handle_Play(ActionInfo info) {
        ...
        if (_handler.onPlay(theInstanceID, theSpeed)) {
            return true;
        }
    ...
    private boolean handle_GetTransportInfo(ActionInfo info) {
        ...
        if (_handler.onGetTransportInfo(theInstanceID, result)) {
    ...
    private boolean handle_Previous(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Previous_ARG_InstanceID);

        if (_handler.onPrevious(theInstanceID)) {
            return true;
        }
    ...
    private boolean handle_GetMediaInfo(ActionInfo info) {
        ...
        if (_handler.onGetMediaInfo(theInstanceID, result)) {
    ...
    private boolean handle_GetDeviceCapabilities(ActionInfo info) {
        ...
        if (_handler.onGetDeviceCapabilities(theInstanceID, result)) {
    ...
    private boolean handle_Pause(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Pause_ARG_InstanceID);

        if (_handler.onPause(theInstanceID)) {
            return true;
        }
    ...
    private boolean handle_GetCurrentTransportActions(ActionInfo info) {
        ...
        if (_handler.onGetCurrentTransportActions(theInstanceID, result)) {
    ...
    private boolean handle_SetAVTransportURI(ActionInfo info) {
        ...
        if (_handler.onSetAVTransportURI(theInstanceID, theCurrentURI, theCurrentURIMetaData)) {
            return true;
        }
    ...
    private boolean handle_GetPositionInfo(ActionInfo info) {
        ...
        if (_handler.onGetPositionInfo(theInstanceID, result)) {
    ...
    private boolean handle_Stop(ActionInfo info) {
        Long theInstanceID = (Long)info.getArgumentValue(_Stop_ARG_InstanceID);

        if (_handler.onStop(theInstanceID)) {
            return true;
        }
    ...
    private boolean handle_GetTransportSettings(ActionInfo info) {
        ...
        if (_handler.onGetTransportSettings(theInstanceID, result)) {
