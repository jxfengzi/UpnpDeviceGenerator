...
package upnps.api.host.device.mimediarenderer;
...
public class SessionManager extends ServiceHandler {
    ...
    private static final ServiceType SERVICE_TYPE =  new ServiceType("SessionManager", "0.5");
    ...
    public SessionManager(Device device) {
        ...
        PropertyDefinition _A_ARG_TYPE_SessionStatus = new PropertyDefinition(PROPERTY_A_ARG_TYPE_SessionStatus, DataType.STRING, true);
        ...
        _A_ARG_TYPE_SessionStatus_list.appendAllowedValue("Destroy");
