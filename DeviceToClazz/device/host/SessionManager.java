...
public class SessionManager extends ServiceHandler {
    ...
    public class GetSessionCapabilities_Result {
        ...
        public String theNetInterfaceInfo;
    }
    ...
    private UpnpError handle_GetSessionCapabilities(ActionInfo info) {
        ...
        if (! info.setArgumentValue(_GetSessionCapabilities_ARG_NetInterfaceInfo, result.theNetInterfaceInfo, Argument.Direction.OUT)) {
            Log.d(TAG, "setArgumentValue: false");
            return UpnpError.UPNP_ARGUMENT_VALUE_INVALID;
        }
    ...
    public SessionManager(Device device) throws UpnpException {
        ...
        _GetSessionCapabilities.addArgument(new Argument(_GetSessionCapabilities_ARG_NetInterfaceInfo, Argument.Direction.OUT, PROPERTY_NetInterfaceInfo));
        ...
        PropertyDefinition _NetInterfaceInfo = new PropertyDefinition(PROPERTY_NetInterfaceInfo, DataType.STRING, false);
        _service.addProperty(_NetInterfaceInfo);
    ...
    public void setNetInterfaceInfo(String theNetInterfaceInfo) {
         _service.setPropertyValue(PROPERTY_NetInterfaceInfo, theNetInterfaceInfo);
    }

    public String getNetInterfaceInfo() {
         return (String)_service.getPropertyValue(PROPERTY_NetInterfaceInfo);
    }
