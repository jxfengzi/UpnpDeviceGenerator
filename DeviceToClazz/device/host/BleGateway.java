...
package upnps.api.host.device.blegateway;
...
public class BleGateway implements UpnpActionHandler {
    ...
    public BleGateway(Context context, DeviceConfig config) throws UpnpException {
